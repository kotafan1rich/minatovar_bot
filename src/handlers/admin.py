...
def register_handlers_admin(dp: Dispatcher):
    dp.message.register(
        change_shoes_price, Command("shoes"), F.from_user.id.in_(admins)
    )
    dp.message.register(
        change_cloth_price, Command("cloth"), F.from_user.id.in_(admins)
    )
    dp.message.register(
        change_current_rate, Command("rate"), F.from_user.id.in_(admins)
    )
    dp.message.register(admin_help, Command("adminhelp"), F.from_user.id.in_(admins))
